import {
  Baby, Car, GraduationCap, Home, PiggyBank, Plane,
  Receipt, ShieldCheck, Sparkles, TrendingUp, Wallet,
  type LucideIcon,
} from "lucide-react";
...
// The Purpose *picker* is a different context (choosing among 11 options up front, same job the
