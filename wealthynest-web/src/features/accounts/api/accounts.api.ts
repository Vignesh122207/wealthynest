...
import type { AccountTransfer, CreateAccountPayload, TransferPayload, WalletAccount } from "../types/account.types";
...
export const accountsApi = {
  ...
  deleteAccount: async (id: string): Promise<void> => { await apiClient.delete(`/accounts/${id}`); },
