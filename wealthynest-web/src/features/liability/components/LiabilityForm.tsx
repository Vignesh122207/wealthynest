...
import { liabilitySchema, type LiabilityFormValues } from "../schemas/liability.schema";
    ...
    <TransactionModalOverlay onDismiss={onCancel}>
      <FormModalShell accent="from-red-400 to-rose-500">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <BigAmountInput label="Outstanding Balance" colorClass="text-red-500 dark:text-red-400"
