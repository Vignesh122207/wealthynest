...
export function AuthCard({ children, className, animation = "fade-in-up" }: {
  children: ReactNode;
  className?: string;
  /** Popups in TransactionModalOverlay need "scale-in" — fade-in-up's translateY briefly overflows the card's bounds and flickers the ancestor's scrollbar. */
  ...
  return (
    <div className={cn(
      ...
      animation === "fade-in-up" ? "animate-fade-in-up" : "animate-scale-in",
      className
    )}>
