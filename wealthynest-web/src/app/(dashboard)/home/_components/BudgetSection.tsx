...
export function BudgetSection({ budgetSummaries, viewMode, year, month, isLoading }: BudgetSectionProps) {
  ...
  return (
    <div data-testid="budget-section" className="bg-card rounded-xl shadow-soft dark:shadow-none dark:border dark:border-border/50 p-5 animate-fade-in-up delay-300 h-full flex flex-col card-hover">
