  ...
  return (
    <div className="lg:col-span-2 bg-card border border-border rounded-2xl p-5">
      ...
      <div className="space-y-2">
        {/* Purpose-tagged money (Emergency Fund, etc.) is earmarked, not separate — it's shown
            in the "By Purpose" section below instead of getting its own carved-out row here. */}
        <Link href="/accounts"
          ...
          {loadingSum
            ...
            : <p className="text-sm font-bold tabular-nums text-emerald-600 dark:text-emerald-400">{fmt(summary?.liquidBalance ?? 0)}</p>}
        </Link>
