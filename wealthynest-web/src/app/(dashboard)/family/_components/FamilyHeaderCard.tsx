...
import {Crown, Loader2, Pencil, Users, X} from "lucide-react";
          ...
          {mode === "rename" ? (
            <div className="flex items-center gap-2">
              <input value={renameName} onChange={e => setRenameName(e.target.value)}
                ...
                data-testid="family-rename-input"
            ...
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-foreground truncate" data-testid="family-name-display">{family.name}</h2>
              {isAdmin && (
                <button onClick={onEnterRename} data-testid="family-rename-trigger"
