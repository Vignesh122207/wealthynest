        ...
        <div className="max-w-lg md:max-w-4xl mx-auto space-y-5">
          ...
          <div className="flex items-center justify-end">
            <Link href="/settings/support/tickets/new"
              className="inline-flex items-center gap-1.5 text-sm font-medium bg-gradient-to-br from-blue-700 to-blue-600 shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 hover:-translate-y-0.5 text-white px-3.5 py-2 rounded-xl transition-all">
          ...
          {isLoading ? (
            ...
            <div className="bg-card border border-border rounded-2xl">
              <EmptyState
                ...
                action={
                  <Link href="/settings/support/tickets/new"
                    className="inline-flex items-center gap-1.5 text-sm font-medium bg-gradient-to-br from-blue-700 to-blue-600 shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 hover:-translate-y-0.5 text-white px-4 py-2 rounded-xl transition-all">
