...
export const metadata: Metadata = {
  ...
  icons: {
    icon:  [
      { url: "/icons/icon-192.png?v=ribbonw-indigo", sizes: "192x192", type: "image/png" },
      { url: "/icons/icon-512.png?v=ribbonw-indigo", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/icons/icon-192.png?v=ribbonw-indigo", sizes: "192x192" }],
  },
};
